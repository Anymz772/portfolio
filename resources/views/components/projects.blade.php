...
@php
    $defaultImages = [
        'speed-contractor-system-lap' => 'images/project-procurement.svg',
        'tadika-alumni-management-system' => 'images/project-alumni.svg',
    ];
@endphp
        ...
        <div class="mt-14 grid gap-7 md:grid-cols-2 lg:grid-cols-3">
            @foreach($projects as $project)
                @php
                    ...
                    $tags = array_values(array_filter((array) $project->technologies));
                @endphp
